...
// It self-injects HTML + CSS and locks down mobile gesture/zoom
// quirks shared across the dashboard's pages.
// =============================================================
(function () {
  'use strict';
...
`;
  ...
  // When the habit tracker is iframed inside health.html, the embedded
